...
<table border="0" width="100%">
	<tr>
		<td align="center">
			<b style="color:blue">* 스마트폰 계좌이체 결제 *</b>
		</td>
	</tr>
</table>
<BR>
...
<tr>
	<td width="50%" valign="top">
      ...
      <tr> 
          ...
          <td class="TEXT"><input type="text" name='buyr_name' size="20" maxlength="20" value="변증오"></td>
      </tr>
      <tr> 
...
<form name="pay_form" method="POST" action="../common/pp_ax_hub.php">
    ...
    <input type="hidden" name="use_pay_method" value="010000000000">      <!-- 요청된 결제 수단   -->
	<input type="hidden" name="param_opt_1"	   value="<?=$param_opt_1?>">
	<input type="hidden" name="param_opt_2"	   value="<?=$param_opt_2?>">
	<input type="hidden" name="param_opt_3"	   value="<?=$param_opt_3?>">
</form>
