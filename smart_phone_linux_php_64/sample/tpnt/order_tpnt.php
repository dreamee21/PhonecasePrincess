...
<script language="javascript">
   ...
   /* 주문번호 생성 예제 */
	...
	function call_pay_form()
    {
        ...
        layer_tpnt_obj = document.getElementById("layer_tpnt");

        layer_cont_obj.style.display = "none";
        layer_tpnt_obj.style.display = "block";

        v_frm.target = "frm_tpnt";
        v_frm.action = PayUrl;
...
<table border="0" width="100%">
	<tr>
		<td align="center">
			...
			<b style="color:blue">* 스마트폰 복지포인트 결제 *</b>
...
<tr>
	<td width="50%" valign="top">
      ...
      <tr> 
          <td class="HEAD">good_mny(결제금액)</td>
...
<!-- 결제수단-->
<input type="hidden" name='pay_method'   value="TPNT">
<!-- 주문번호 -->
...
<!-- 인증시 필요한 파라미터(변경불가)-->
<input type="hidden" name='ActionResult' value="tpnt">
<!-- 인증시 필요한 파라미터(변경불가)-->
<input type="hidden" name='van_code'     value="SCWB">
<!-- 화면 크기조정 부분 - Start - -->
...
<div id="layer_tpnt" style="position:absolute; left:1px; top:1px; width:310;height:400; z-index:1; display:none;">
    <table width="310" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <iframe name="frm_tpnt" frameborder="0" border="0" width="310" height="400" scrolling="auto"></iframe>
           </td>
        </tr>
    </table>
</div>
...
<form name="pay_form" method="POST" action="../common/pp_ax_hub.php">
    ...
    <input type="hidden" name="use_pay_method" value="000100000000">      <!-- 요청된 결제 수단   -->
</form>
</body>
</html>