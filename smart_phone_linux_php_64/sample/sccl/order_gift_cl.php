   ...
   /* 주문번호 생성 예제 */
    ...
    function call_pay_form()
    {
       var v_frm = document.sm_form;
        ...
        layer_sccl_obj = document.getElementById("layer_sccl");

        layer_cont_obj.style.display = "none";
        layer_sccl_obj.style.display = "block";

        v_frm.target = "frm_sccl";
        v_frm.action = PayUrl;
...
<table border="0" width="100%" align="center">
	<tr>
		<td align="center">
			...
			<b style="color:blue">* 스마트폰 문화상품권 결제 *</b>
...
<tr>
	<td width="50%" valign="top">
      ...
      <tr> 
                <td class="HEAD">good_mny(상품단가)</td>
...
<!-- 결제수단-->
<input type="hidden" name='pay_method'   value="GIFT">
<!-- 주문번호 -->
...
<!-- 인증시 필요한 파라미터(변경불가)-->
<input type="hidden" name='ActionResult' value="sccl">
<!-- 인증시 필요한 파라미터(변경불가)-->
<input type="hidden" name='van_code'     value="SCCL">
<!-- tk_shop_id 값 설정 하위가맹점 아이디 -->
...
<div id="layer_sccl" style="position:absolute; left:1px; top:1px; width:310;height:400; z-index:1; display:none;">
    <table width="310" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <iframe name="frm_sccl" frameborder="0" border="0" width="310" height="400" scrolling="auto"></iframe>
           </td>
        </tr>
    </table>
</div>
...
<form name="pay_form" method="POST" action="../common/pp_ax_hub.php">
    ...
    <input type="hidden" name="use_pay_method" value="000000001000">              <!-- 요청된 결제 수단   -->
</form>
</body>
</html>
